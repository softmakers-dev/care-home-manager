...
set JARPATH=%APP_HOME%\lib\manager_boot-0.0.1-SNAPSHOT.jar

@rem Execute manager_boot
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MANAGER_BOOT_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%MANAGER_BOOT_EXIT_CONSOLE%" exit 1
exit /b 1
